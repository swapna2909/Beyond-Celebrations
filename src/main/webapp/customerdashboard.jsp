...
<body class="bg-gray-100" style="font-family: Poppins;">
		...
		<div class="max-w-7xl mx-auto px-8">
			...
			<div class="flex justify-between items-center h-20">
				...
				<ul class="hidden lg:flex gap-8 font-medium">
					...
					<li><a href="bookevents.jsp" class="hover:text-purple-700">Bookings</a></li>
	...
	<div class="max-w-7xl mx-auto px-8 pb-12">
		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
			...
			<div
				class="bg-white rounded-2xl shadow-lg p-6 hover:-translate-y-2 transition">
				...
				<div class="flex justify-between items-center">
					...
					<div>
						...
						<h2 class="text-4xl font-bold text-purple-700 mt-2">12</h2>
			...
			<div
				...
				<div class="flex justify-between items-center">
					...
					<div>
						...
						<h2 class="text-4xl font-bold text-pink-600 mt-2">4</h2>
			...
			<div
				...
				<div class="flex justify-between items-center">
					...
					<div>
						...
						<h2 class="text-4xl font-bold text-red-500 mt-2">6</h2>
			...
			<div
				...
				<div class="flex justify-between items-center">
					...
					<div>
						...
						<h2 class="text-4xl font-bold text-yellow-500 mt-2">850</h2>
	...
	<section class="max-w-7xl mx-auto px-8 pb-16">
		...
		<h2 class="text-3xl font-bold text-gray-800 mb-8">Explore Event
			Categories</h2>

		<div class="grid grid-cols-2 md:grid-cols-4 gap-6">

			<div
				class="bg-white rounded-2xl shadow-lg p-8 text-center hover:bg-purple-700 hover:text-white transition">
			...
			<div
				class="bg-white rounded-2xl shadow-lg p-8 text-center hover:bg-pink-600 hover:text-white transition">
			...
			<div
				class="bg-white rounded-2xl shadow-lg p-8 text-center hover:bg-blue-600 hover:text-white transition">
			...
			<div
				class="bg-white rounded-2xl shadow-lg p-8 text-center hover:bg-orange-500 hover:text-white transition">

				<i class="fa-solid fa-heart text-5xl mb-4"></i>

				<h3 class="font-semibold">Anniversary</h3>
	...
	<section class="max-w-7xl mx-auto px-8 pb-16">
		...
		<div class="grid md:grid-cols-3 gap-8">
			...
			<div
				class="bg-white rounded-3xl shadow-xl overflow-hidden hover:scale-105 transition">
				...
				<div class="p-6">
					...
					<button
						class="mt-5 w-full py-3 rounded-xl bg-purple-700 text-white hover:bg-purple-800">
			...
			<div
				...
				<div class="p-6">
					...
					<button
						class="mt-5 w-full py-3 rounded-xl bg-pink-600 text-white hover:bg-pink-700">
			...
			<div
				...
				<div class="p-6">
					...
					<button
						class="mt-5 w-full py-3 rounded-xl bg-blue-600 text-white hover:bg-blue-700">
	...
	<section class="max-w-7xl mx-auto px-8 py-12">
		...
		<div
			class="rounded-3xl bg-gradient-to-r from-purple-700 via-pink-600 to-orange-500 text-white p-10 shadow-xl">
			...
			<p class="mt-5 text-lg leading-8">
				...
				Book any Premium Wedding Package this month and receive <span
					class="font-bold">15% Discount</span>, complimentary photography,
		...
		<div class="max-w-7xl mx-auto px-8 py-12">
			...
			<div class="grid md:grid-cols-4 gap-10">
				...
				<div>
					...
					<h2 class="text-3xl text-yellow-300" style="font-family: Cinzel;">

						Beyond Celebrations</h2>

					<p class="text-yellow-200 text-xl"
						style="font-family: 'Great Vibes';">More than events, we
						create experiences</p>

					<p class="mt-5 text-gray-400 leading-7">Your trusted event
						planning partner.</p>
